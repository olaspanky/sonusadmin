...
import Users from "../../components/settings/Users3";
...
import PasswordForm from "@/app/components/Password3";
...
const Home = () => {
  ...
  return (
    ...
    <main className="flex w-full">
      {authenticated ? (
        <div className="z-40 hidden lg:block bg-white  h-96 sticky top-0   max-h-[1080px]">
        </div>
      ) : (
        <div className="flex w-full  bg-black h-[100vh]">
